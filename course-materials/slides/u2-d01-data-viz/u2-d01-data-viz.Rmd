...
subtitle: "<br><br> Datasets and exploratory data analysis "
...
- The excellent website [From Data to Viz](https://www.data-to-viz.com) leads you to the most appropriate graph for your data. 
...
knitr::include_graphics("img/data-viz-2.png")
```
...
```{r echo=FALSE, out.width="50%"}
knitr::include_graphics("img/data-viz.png")
```
