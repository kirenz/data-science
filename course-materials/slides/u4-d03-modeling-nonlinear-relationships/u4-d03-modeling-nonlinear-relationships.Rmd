...
subtitle: "<br><br> Modeling non-linear relationships (with transformations)"
...
- That is, paintings with width < 2.54 m (100 inch)
...
- However in those cases other model types (e.g., smoothing splines or a decision tree) may be more appropriate).
